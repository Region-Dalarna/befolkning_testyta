...
Detta repository innehåller en Shinyapplikation (`befolkning_testyta`) för Samhällsanalys, Region Dalarna.
...
- Deployment sker via GitHub Actions:
  ...
  Appmapp på servern: `/srv/shiny-server/befolkning_testyta`.
